...
namespace NoticeBoard.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult ae(string id)
        {
            ViewData["id"] = id;
            return View();
        }
        public ActionResult ce(string id)
        {
            ViewData["id"] = id;
            return View();
        }
        public ActionResult civ(string id)
        {
            ViewData["id"] = id;
            return View();
        }
        ...
        public ActionResult ee(string id)
        {
            ViewData["id"] = id;
            return View();
        }
        public ActionResult mec(string id)
        {
            ViewData["id"] = id;
            return View();
        }
